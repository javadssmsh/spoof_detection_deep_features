...
X_train = np.load("/home/rohita/rohit/spoof/npy_data_asvspoof/ASVspoof2019_train_sub.npy",allow_pickle=True)
with open("/home/rohita/rohit/spoof/npy_data_asvspoof/ASVspoof2019_train_df_sub.pkl", 'rb') as pickle_file:
    y_train = pickle.load(pickle_file)
y_train = y_train.reset_index(drop=True)
X_val = np.load("/home/rohita/rohit/spoof/npy_data_asvspoof/ASVspoof2019_dev_sub.npy", allow_pickle=True)
with open("/home/rohita/rohit/spoof/npy_data_asvspoof/ASVspoof2019_dev_df_sub.pkl", 'rb') as pickle_file:
...
batch_size = 128
logs_path = '/home/rohita/rohit/spoof/npy_data_asvspoof/Sincnet/equal_human_spoof/single_condition'
model_path = '/home/rohita/rohit/spoof/npy_data_asvspoof/Sincnet/equal_human_spoof/single_condition/model.ckpt'
# Run training loop
with sess.as_default():
    ...
    for epoch in range(20):
        ...
        for i in range(total_batch_train):
            ...
            average_acc_train += acc_train / total_batch_train
            average_loss_train += loss_train / total_batch_train
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig('/home/rohita/rohit/spoof/npy_data_asvspoof/Sincnet/equal_human_spoof/single_condition/acc_plot.png')
    plt.clf()
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('/home/rohita/rohit/spoof/npy_data_asvspoof/Sincnet/equal_human_spoof/single_condition/loss_plot.png')
