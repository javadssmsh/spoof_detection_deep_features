...
with sess.as_default():
    ...
    train_summary_writer = tf.summary.FileWriter(logs_path+'/Train_whole_dataset_RMS_try',
                                            graph=tf.get_default_graph())
    val_summary_writer = tf.summary.FileWriter(logs_path+'/Val_whole_dataset_RMS_try')
